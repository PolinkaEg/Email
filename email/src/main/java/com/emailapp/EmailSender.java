...
public class EmailSender {
    ...
    public static void sendEmail(String recipient, String subject, String content) {
        final String username = "coursework05@mail.ru"; // Замените на ваш адрес Mail.ru
        final String password = "TgwNkhZT7vajRdGSmcBM"; // Замените на ваш пароль Mail.ru
        ...
        //     message.setFrom(new InternetAddress("coursework05@mail.ru")); // Ваш адрес Mail.ru
    ...
    public static void main(String[] args) {
        String emailFilePath = "C:\\Users\\egoro\\КР\\email\\src\\emails.txt"; // Замените на фактический путь к файлу
        String messageFilePath = "C:\\Users\\egoro\\КР\\email\\src\\message.txt"; // Замените на фактический путь к файлу
